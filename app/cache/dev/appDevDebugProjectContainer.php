...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'tsdb', 'user' => 'root', 'password' => 'admin', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/src/Imaginativo/Bundle/TSBundle/Resources/config/doctrine') => 'Imaginativo\\Bundle\\TSBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Imaginativo\\Bundle\\TSBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('ImaginativoTSBundle' => 'Imaginativo\\Bundle\\TSBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4933deeee25c5d2a41fc43cab913ccc06fad575a69cf5e41ecd55b1f50443d23');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Imaginativo/Bundle/TSBundle/Resources/views'), 'ImaginativoTS');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a2e1307ac9737be7088bd286c7beda337625233e');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ImaginativoTSBundle' => 'Imaginativo\\Bundle\\TSBundle\\ImaginativoTSBundle',
            ...
            'locale' => 'en',
            'secret' => 'a2e1307ac9737be7088bd286c7beda337625233e',
            ...
            'kernel.secret' => 'a2e1307ac9737be7088bd286c7beda337625233e',
