 ...
 */
class Conta extends \Imaginativo\Bundle\TSBundle\Entity\Conta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Imaginativo\\Bundle\\TSBundle\\Entity\\Conta' . "\0" . 'id', '' . "\0" . 'Imaginativo\\Bundle\\TSBundle\\Entity\\Conta' . "\0" . 'nome', '' . "\0" . 'Imaginativo\\Bundle\\TSBundle\\Entity\\Conta' . "\0" . 'razaoSocial', '' . "\0" . 'Imaginativo\\Bundle\\TSBundle\\Entity\\Conta' . "\0" . 'cNPJ', '' . "\0" . 'Imaginativo\\Bundle\\TSBundle\\Entity\\Conta' . "\0" . 'nomeFantasia', '' . "\0" . 'Imaginativo\\Bundle\\TSBundle\\Entity\\Conta' . "\0" . 'dtCriacao', '' . "\0" . 'Imaginativo\\Bundle\\TSBundle\\Entity\\Conta' . "\0" . 'obs', '' . "\0" . 'Imaginativo\\Bundle\\TSBundle\\Entity\\Conta' . "\0" . 'equipes', '' . "\0" . 'Imaginativo\\Bundle\\TSBundle\\Entity\\Conta' . "\0" . 'clientes', '' . "\0" . 'Imaginativo\\Bundle\\TSBundle\\Entity\\Conta' . "\0" . 'endereco', '' . "\0" . 'Imaginativo\\Bundle\\TSBundle\\Entity\\Conta' . "\0" . 'status');
        }
    ...
    public function addEquipe(\Imaginativo\Bundle\TSBundle\Entity\Equipe $equipes)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addEquipe', array($equipes));

        return parent::addEquipe($equipes);
    }
    ...
    public function removeEquipe(\Imaginativo\Bundle\TSBundle\Entity\Equipe $equipes)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeEquipe', array($equipes));

        return parent::removeEquipe($equipes);
    }
