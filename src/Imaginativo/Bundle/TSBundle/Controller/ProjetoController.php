...
use Imaginativo\Bundle\TSBundle\Entity\Projeto;
use Imaginativo\Bundle\TSBundle\Form\ProjetoType;
...
class ProjetoController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ImaginativoTSBundle:Projeto:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ImaginativoTSBundle:Projeto')->find($id);
        ...
        return $this->render('ImaginativoTSBundle:Projeto:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ImaginativoTSBundle:Projeto:edit.html.twig', array(
            'entity'      => $entity,
